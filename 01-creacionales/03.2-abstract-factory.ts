...
class ElectricCar implements Vehicle {
  assemble(): void {
    console.log("%cAssembling an electric car", COLORS.yellow);
  }
...
class GasCar implements Vehicle {
  assemble(): void {
    console.log("%cAssembling a gas car", COLORS.gray);
  }
  // Implementación del método assemble
...
class ElectricEngine implements Engine {
  start(): void {
    console.log("%cStarting electric engine", COLORS.yellow);
  }
...
class GasEngine implements Engine {
  start(): void {
    console.log("%cStarting gas engine", COLORS.gray);
  }
  // Implementación del método start
